...
void HackerContext::BeforeDraw(DrawContext &data)
{
	...
	if (G->decompile_auto_vs || G->decompile_auto_ps)
		PassiveDecompileDrawShaders(mHackerDevice,
				mCurrentVertexShaderHandle, mCurrentVertexShader,
				mCurrentPixelShaderHandle, mCurrentPixelShader);
	...
	D3D11_MAPPED_SUBRESOURCE *pMappedResource)
{
	...
	return matches.front()->deny_cpu_read;
}
